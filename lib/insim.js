...
var IS_MTC.prototype.pack = function(values)
{
...
var CONF_DISQ = (CONF_PENALTY_DT | var CONF_PENALTY_SG | var CONF_DID_NOT_PIT);
var CONF_TIME = (CONF_PENALTY_30 | var CONF_PENALTY_45);
...
var IS_NLP.prototype.unpack = function(buf)
{
	var self = this;
...
var IS_MCI.prototype.pack = function()
{
	throw new Error('Unsupported at this time');
}

var IS_MCI.prototype.unpack = function(buf)
{
	var self = this;
...
var IS_CON.prototype.unpack = function(buf)
{
	var self = this;
...
var IS_HLV.prototype.unpack = function(buf)
{
	var self = this;
...
var IS_AXM.prototype.unpack = function(buf)
{
	var self = this;
...
var IS_BTN.prototype.pack = function(values)
{
	var len = this.text.length + 1;
