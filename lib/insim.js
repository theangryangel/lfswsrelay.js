...
inherits(IS_TINY, lfswsrelay.packets.IS_NONE);
...
inherits(IS_SMALL, lfswsrelay.packets.IS_NONE);
...
inherits(IS_NCN, lfswsrelay.packets.IS_NONE);
...
inherits(IS_CNL, lfswsrelay.packets.IS_NONE);
...
inherits(IS_NPL, lfswsrelay.packets.IS_NONE);
...
inherits(IS_PLP, lfswsrelay.packets.IS_NONE);
